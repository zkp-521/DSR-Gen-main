...
dis_p = MsImageDis(input_dim=1,gan_type='lsgan').cuda()
...
for epoch in range(55):
    ...
    if epoch >40:
        torch.save(gen_p.state_dict(), 'mr_head_ourmode_resvit_ls_c_{}.pkl'.format(epoch))
